  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center gap-4 w-full">
        ...
        <button className="px-4 py-3 rounded-md dark:text-neutral-700 text-neutral-200 dark:bg-[#A8A5FF] 
      ...
      <div className="flex flex-col justify-center items-center gap-4 w-full">
        <h3 className="dark:text-[#A8A5FF] text-[#7470dc] text-xl font-semibold">Shareable link</h3>
        <p className="text-sm dark:text-neutral-200 text-neutral-700">Export as a read-only link. </p>
        <button className="px-4 py-3 rounded-md dark:text-neutral-700 text-neutral-200 dark:bg-[#A8A5FF] 
        bg-[#7470dc] text-sm flex justify-center items-center gap-2 cursor-pointer hover:opacity-90">
          <IoIosLink size={20} />
